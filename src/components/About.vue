  ...
  <section id="about" class="bg-white dark:bg-gray-900 py-16 md:py-24 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
      ...
      <div class="grid md:grid-cols-2 gap-8 items-center">
        <div class="space-y-6 text-lg text-black dark:text-black leading-relaxed text-justify">
          <p>
            Bonjour, je suis Tuan Kene, développeur Full Stack passionné par la création d'applications web
            modernes et performantes. Avec une solide expérience dans le développement frontend et backend,
            je me spécialise dans la conception et la réalisation de solutions digitales innovantes.
          </p>
          <p>
        ...
        <div class="flex justify-center">
          <div
            class="w-64 h-64 rounded-full overflow-hidden shadow-2xl border-4 border-primary-200 dark:border-primary-800">
            <img src="@/assets/image/1580415323713.jpg" alt="Tuan Kene" class="w-full h-full object-cover" />
          </div>
        </div>
      </div>
    </div>
